...
CREATE TABLE `employee` (
                            ...
                            `overtime_worked` int DEFAULT NULL,
                            PRIMARY KEY (`id`)
...
CREATE TABLE `salary` (
                          `id` int NOT NULL,
                          `base_salary_per_hour` int DEFAULT NULL,
                          `employee_increas` int DEFAULT NULL,
                          `salary_overtime` int DEFAULT NULL,
...
-- Dump completed on 2022-11-11 14:17:25
